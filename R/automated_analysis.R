...
automated_functional_analysis <- function( my_geneset, 
  ...
  df_singleton <- place_singletons_alternative( df_out, interactions, mapped_proteins  )
  ...
  df_ora <- get_community_representatives_alternative( layout_fr, universe, selection, databases_tested, threshold_mean, threshold_min, ora_min, ora_max, folder_databases )
